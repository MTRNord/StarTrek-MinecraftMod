...
public enum EnumToolMaterialStarTreck
{
    ...
    TITANIUM(5, 6000, 16.0F, 10.0F, 22);
    ...
    private EnumToolMaterialStarTreck(int par3, int par4, float par5, float par6, int par7)
    {
    ...
    public int getToolCraftingMaterial()
    {
        ...
        switch (this)
        {
            ...
            case TITANIUM: return StarTreckMod.titaniumIngotID;
