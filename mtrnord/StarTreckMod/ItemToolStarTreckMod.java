...
public class ItemToolStarTreckMod extends Item
{
    ...
    protected EnumToolMaterialStarTreck toolMaterial;

    protected ItemToolStarTreckMod(int par1, float par2, EnumToolMaterialStarTreck par3EnumToolMaterial, Block[] par4ArrayOfBlock)
    {
        super(par1);
